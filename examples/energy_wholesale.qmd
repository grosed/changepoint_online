...
time_delta = df_test.iloc[stopping_time].time - df_test.iloc[changepoint].time

```

It took us about `{python} round(time_delta.total_seconds()/3600)` hours to detect a change!
